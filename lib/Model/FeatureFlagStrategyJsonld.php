...
/**
 * FeatureFlagStrategyJsonld Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class FeatureFlagStrategyJsonld implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureFlagStrategy.jsonld';
    ...
    protected static $openAPITypes = [
        ...
        'parameters' => 'string[]',
        'feature_flag' => 'string',
        'tenants' => '\OpenAPI\Client\Model\TenantJsonld[]',
        'users' => '\OpenAPI\Client\Model\UserJsonld[]',
        'uuid' => 'string',
        'tenant' => 'string'
    ];
    ...
    */
     ...
     * Gets tenants
     *
     * @return \OpenAPI\Client\Model\TenantJsonld[]|null
     */
     ...
     * Sets tenants
     *
     * @param \OpenAPI\Client\Model\TenantJsonld[]|null $tenants tenants
     *
     * @return self
     */
     ...
     * Gets users
     *
     * @return \OpenAPI\Client\Model\UserJsonld[]|null
     */
     ...
     * Sets users
     *
     * @param \OpenAPI\Client\Model\UserJsonld[]|null $users users
     *
     * @return self
     */
