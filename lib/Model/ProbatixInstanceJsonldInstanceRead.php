...
/**
 * ProbatixInstanceJsonldInstanceRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class ProbatixInstanceJsonldInstanceRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProbatixInstance.jsonld-instance.read';
