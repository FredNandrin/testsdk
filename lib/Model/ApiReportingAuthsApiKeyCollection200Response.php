...
/**
 * ApiReportingAuthsApiKeyCollection200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiReportingAuthsApiKeyCollection200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api_reporting_auths_ApiKey_collection_200_response';
    ...
    protected static $openAPITypes = [
        'hydramember' => '\OpenAPI\Client\Model\ReportingAuthJsonld[]',
    ...
    */
     ...
     * Gets hydramember
     *
     * @return \OpenAPI\Client\Model\ReportingAuthJsonld[]
     */
     ...
     * Sets hydramember
     *
     * @param \OpenAPI\Client\Model\ReportingAuthJsonld[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling ApiReportingAuthsApiKeyCollection200Response., must be bigger than or equal to 0.');
        }
