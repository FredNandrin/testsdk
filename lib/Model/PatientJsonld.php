...
/**
 * PatientJsonld Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class PatientJsonld implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Patient.jsonld';
    ...
    protected static $attributeMap = [
        ...
        'autocomplete_string' => 'autocompleteString',
        'full_name' => 'fullName',
        'underage' => 'underage',
    ...
    protected static $setters = [
        ...
        'autocomplete_string' => 'setAutocompleteString',
    ...
    protected static $getters = [
        ...
        'autocomplete_string' => 'getAutocompleteString',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('patient_code', $data ?? [], null);
        ...
        $this->setIfExists('autocomplete_string', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['patient_code'];
    }

    /**
     * Sets patient_code
     *
     * @param string|null $patient_code patient_code
     *
     * @return self
     */
    public function setPatientCode($patient_code)
    {
        if (is_null($patient_code)) {
            throw new \InvalidArgumentException('non-nullable patient_code cannot be null');
        }
        $this->container['patient_code'] = $patient_code;
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling PatientJsonld., must be smaller than or equal to 100.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling PatientJsonld., must be smaller than or equal to 100.');
        }
    ...
    public function setCompany($company)
    {
        ...
        if (!is_null($company) && (mb_strlen($company) > 200)) {
            throw new \InvalidArgumentException('invalid length for $company when calling PatientJsonld., must be smaller than or equal to 200.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PatientJsonld., must be smaller than or equal to 100.');
        }
    ...
    public function setGender($gender)
    {
        ...
        if (!is_null($gender) && (mb_strlen($gender) > 20)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling PatientJsonld., must be smaller than or equal to 20.');
        }
    ...
    public function setPersonalIdNumber($personal_id_number)
    {
        ...
        if (!is_null($personal_id_number) && (mb_strlen($personal_id_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $personal_id_number when calling PatientJsonld., must be smaller than or equal to 100.');
        }
    ...
    public function setHealthInsurancePolicyNumber($health_insurance_policy_number)
    {
        ...
        if (!is_null($health_insurance_policy_number) && (mb_strlen($health_insurance_policy_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $health_insurance_policy_number when calling PatientJsonld., must be smaller than or equal to 50.');
        }
    ...
    public function setHealthInsuranceCompanyNumber($health_insurance_company_number)
    {
        ...
        if (!is_null($health_insurance_company_number) && (mb_strlen($health_insurance_company_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $health_insurance_company_number when calling PatientJsonld., must be smaller than or equal to 50.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling PatientJsonld., must be smaller than or equal to 100.');
        }
    ...
    public function setAddressZipCode($address_zip_code)
    {
        ...
        if (!is_null($address_zip_code) && (mb_strlen($address_zip_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_zip_code when calling PatientJsonld., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressCity($address_city)
    {
        ...
        if (!is_null($address_city) && (mb_strlen($address_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_city when calling PatientJsonld., must be smaller than or equal to 100.');
        }
    ...
    public function setAddressCountry($address_country)
    {
        ...
        if (!is_null($address_country) && (mb_strlen($address_country) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_country when calling PatientJsonld., must be smaller than or equal to 100.');
        }
    ...
    /**
     * Gets autocomplete_string
     *
     * @return string|null
     */
    public function getAutocompleteString()
    {
        return $this->container['autocomplete_string'];
    }

    /**
     * Sets autocomplete_string
     *
     * @param string|null $autocomplete_string autocomplete_string
     *
     * @return self
     */
    public function setAutocompleteString($autocomplete_string)
    {
        if (is_null($autocomplete_string)) {
            throw new \InvalidArgumentException('non-nullable autocomplete_string cannot be null');
        }
        $this->container['autocomplete_string'] = $autocomplete_string;
