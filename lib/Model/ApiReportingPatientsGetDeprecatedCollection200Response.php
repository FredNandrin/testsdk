...
/**
 * ApiReportingPatientsGetDeprecatedCollection200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiReportingPatientsGetDeprecatedCollection200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api_reporting_patients_get_deprecated_collection_200_response';
    ...
    protected static $openAPITypes = [
        'hydramember' => '\OpenAPI\Client\Model\ReportingPatientJsonldPatientRead[]',
    ...
    */
     ...
     * Gets hydramember
     *
     * @return \OpenAPI\Client\Model\ReportingPatientJsonldPatientRead[]
     */
     ...
     * Sets hydramember
     *
     * @param \OpenAPI\Client\Model\ReportingPatientJsonldPatientRead[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling ApiReportingPatientsGetDeprecatedCollection200Response., must be bigger than or equal to 0.');
        }
