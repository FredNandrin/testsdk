...
/**
 * ApiApiInternalcustomPrintingWorkflowsGetCollection200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiApiInternalcustomPrintingWorkflowsGetCollection200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api_api_internalcustom_printing_workflows_get_collection_200_response';
    ...
    protected static $openAPITypes = [
        'hydramember' => '\OpenAPI\Client\Model\CustomPrintingWorkflowJsonld[]',
    ...
    */
     ...
     * Gets hydramember
     *
     * @return \OpenAPI\Client\Model\CustomPrintingWorkflowJsonld[]
     */
     ...
     * Sets hydramember
     *
     * @param \OpenAPI\Client\Model\CustomPrintingWorkflowJsonld[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling ApiApiInternalcustomPrintingWorkflowsGetCollection200Response., must be bigger than or equal to 0.');
        }
