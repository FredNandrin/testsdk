...
/**
 * ApiLocationsGetBackendCollection200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiLocationsGetBackendCollection200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api_locations_get_backend_collection_200_response';
    ...
    protected static $openAPITypes = [
        'hydramember' => '\OpenAPI\Client\Model\LocationJsonldLocationReadBackend[]',
    ...
    */
     ...
     * Gets hydramember
     *
     * @return \OpenAPI\Client\Model\LocationJsonldLocationReadBackend[]
     */
     ...
     * Sets hydramember
     *
     * @param \OpenAPI\Client\Model\LocationJsonldLocationReadBackend[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling ApiLocationsGetBackendCollection200Response., must be bigger than or equal to 0.');
        }
