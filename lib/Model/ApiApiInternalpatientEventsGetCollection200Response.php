...
/**
 * ApiApiInternalpatientEventsGetCollection200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiApiInternalpatientEventsGetCollection200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api_api_internalpatient_events_get_collection_200_response';
    ...
    protected static $openAPITypes = [
        'hydramember' => '\OpenAPI\Client\Model\PatientEventJsonld[]',
    ...
    */
     ...
     * Gets hydramember
     *
     * @return \OpenAPI\Client\Model\PatientEventJsonld[]
     */
     ...
     * Sets hydramember
     *
     * @param \OpenAPI\Client\Model\PatientEventJsonld[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling ApiApiInternalpatientEventsGetCollection200Response., must be bigger than or equal to 0.');
        }
