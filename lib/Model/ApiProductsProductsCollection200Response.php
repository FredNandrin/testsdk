...
/**
 * ApiProductsProductsCollection200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiProductsProductsCollection200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api_products_products_collection_200_response';
    ...
    protected static $openAPITypes = [
        'hydramember' => '\OpenAPI\Client\Model\ProductProductOutputDtoJsonldProductRead[]',
    ...
    */
     ...
     * Gets hydramember
     *
     * @return \OpenAPI\Client\Model\ProductProductOutputDtoJsonldProductRead[]
     */
     ...
     * Sets hydramember
     *
     * @param \OpenAPI\Client\Model\ProductProductOutputDtoJsonldProductRead[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling ApiProductsProductsCollection200Response., must be bigger than or equal to 0.');
        }
