...
/**
 * MyBookingDtoBookingReadReact Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class MyBookingDtoBookingReadReact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MyBookingDto-booking.read_react';
    ...
    protected static $openAPITypes = [
        ...
        'product' => '\OpenAPI\Client\Model\ProductDtoBookingReadReact',
        'biomarkers' => 'string[]',
        'test_code' => 'string',
        'location' => '\OpenAPI\Client\Model\LocationOutputDtoBookingReadReact',
        'results' => 'string[]',
        'test_type' => 'string',
    ...
    */
     ...
     * Gets product
     *
     * @return \OpenAPI\Client\Model\ProductDtoBookingReadReact|null
     */
     ...
     * Sets product
     *
     * @param \OpenAPI\Client\Model\ProductDtoBookingReadReact|null $product product
     *
     * @return self
     */
     ...
     * Gets location
     *
     * @return \OpenAPI\Client\Model\LocationOutputDtoBookingReadReact|null
     */
     ...
     * Sets location
     *
     * @param \OpenAPI\Client\Model\LocationOutputDtoBookingReadReact|null $location location
     *
     * @return self
     */
