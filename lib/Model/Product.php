    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Product., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
    ...
    public function setLoinc($loinc)
    {
        ...
        if (!is_null($loinc) && (mb_strlen($loinc) > 20)) {
            throw new \InvalidArgumentException('invalid length for $loinc when calling Product., must be smaller than or equal to 20.');
        }
    ...
    public function setMaxBookingsPerOrder($max_bookings_per_order)
    {
        ...
        if (!is_null($max_bookings_per_order) && ($max_bookings_per_order <= 0)) {
            throw new \InvalidArgumentException('invalid value for $max_bookings_per_order when calling Product., must be bigger than 0.');
        }
    ...
    public function setMinimumPatientAge($minimum_patient_age)
    {
        ...
        if (!is_null($minimum_patient_age) && ($minimum_patient_age < 0)) {
            throw new \InvalidArgumentException('invalid value for $minimum_patient_age when calling Product., must be bigger than or equal to 0.');
        }
