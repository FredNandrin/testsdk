<?php
/**
 * MyBookingDtoBookingReadReactGeolocationRead
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * MyBookingDtoBookingReadReactGeolocationRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class MyBookingDtoBookingReadReactGeolocationRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MyBookingDto-booking.read_react_geolocation.read';
    ...
    protected static $openAPITypes = [
        ...
        'product' => '\OpenAPI\Client\Model\ProductDtoBookingReadReactGeolocationRead',
        'biomarkers' => 'string[]',
        'test_code' => 'string',
        'location' => '\OpenAPI\Client\Model\LocationOutputDtoBookingReadReactGeolocationRead',
        'results' => 'string[]',
        'test_type' => 'string',
    ...
    */
     ...
     * Gets product
     *
     * @return \OpenAPI\Client\Model\ProductDtoBookingReadReactGeolocationRead|null
     */
     ...
     * Sets product
     *
     * @param \OpenAPI\Client\Model\ProductDtoBookingReadReactGeolocationRead|null $product product
     *
     * @return self
     */
     ...
     * Gets location
     *
     * @return \OpenAPI\Client\Model\LocationOutputDtoBookingReadReactGeolocationRead|null
     */
     ...
     * Sets location
     *
     * @param \OpenAPI\Client\Model\LocationOutputDtoBookingReadReactGeolocationRead|null $location location
     *
     * @return self
     */
