...
/**
 * ProbeIdentifierJsonld Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class ProbeIdentifierJsonld implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProbeIdentifier.jsonld';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ProbeIdentifierJsonld., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ProbeIdentifierJsonld., must be bigger than or equal to 1.');
        }
