...
/**
 * ProbeIdentifier Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class ProbeIdentifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProbeIdentifier';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ProbeIdentifier., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ProbeIdentifier., must be bigger than or equal to 1.');
        }
