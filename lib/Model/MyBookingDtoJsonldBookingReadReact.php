<?php
/**
 * MyBookingDtoJsonldBookingReadReact
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * MyBookingDtoJsonldBookingReadReact Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class MyBookingDtoJsonldBookingReadReact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MyBookingDto.jsonld-booking.read_react';
    ...
    protected static $openAPITypes = [
        ...
        'product' => '\OpenAPI\Client\Model\ProductDtoJsonldBookingReadReact',
        'biomarkers' => 'string[]',
        'test_code' => 'string',
        'location' => '\OpenAPI\Client\Model\LocationOutputDtoJsonldBookingReadReact',
        'results' => 'string[]',
        'test_type' => 'string',
    ...
    */
     ...
     * Gets product
     *
     * @return \OpenAPI\Client\Model\ProductDtoJsonldBookingReadReact|null
     */
     ...
     * Sets product
     *
     * @param \OpenAPI\Client\Model\ProductDtoJsonldBookingReadReact|null $product product
     *
     * @return self
     */
     ...
     * Gets location
     *
     * @return \OpenAPI\Client\Model\LocationOutputDtoJsonldBookingReadReact|null
     */
     ...
     * Sets location
     *
     * @param \OpenAPI\Client\Model\LocationOutputDtoJsonldBookingReadReact|null $location location
     *
     * @return self
     */
