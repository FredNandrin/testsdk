...
/**
 * TenantJsonld Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class TenantJsonld implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tenant.jsonld';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'feature_flag_strategies' => '\OpenAPI\Client\Model\FeatureFlagStrategyJsonld[]',
    ...
    */
    ...
    public function setProviderDeviceIdJrcDatabase($provider_device_id_jrc_database)
    {
        ...
        if (!is_null($provider_device_id_jrc_database) && ($provider_device_id_jrc_database >= 100000)) {
            throw new \InvalidArgumentException('invalid value for $provider_device_id_jrc_database when calling TenantJsonld., must be smaller than 100000.');
        }
        if (!is_null($provider_device_id_jrc_database) && ($provider_device_id_jrc_database <= 0)) {
            throw new \InvalidArgumentException('invalid value for $provider_device_id_jrc_database when calling TenantJsonld., must be bigger than 0.');
        }
    ...
    public function setEditableDays($editable_days)
    {
        ...
        if (($editable_days > 90)) {
            throw new \InvalidArgumentException('invalid value for $editable_days when calling TenantJsonld., must be smaller than or equal to 90.');
        }
        if (($editable_days <= 0)) {
            throw new \InvalidArgumentException('invalid value for $editable_days when calling TenantJsonld., must be bigger than 0.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\FeatureFlagStrategyJsonld[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\FeatureFlagStrategyJsonld[]|null $feature_flag_strategies feature_flag_strategies
     *
     * @return self
     */
