    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling Patient., must be smaller than or equal to 100.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling Patient., must be smaller than or equal to 100.');
        }
    ...
    public function setCompany($company)
    {
        ...
        if (!is_null($company) && (mb_strlen($company) > 200)) {
            throw new \InvalidArgumentException('invalid length for $company when calling Patient., must be smaller than or equal to 200.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Patient., must be smaller than or equal to 100.');
        }
    ...
    public function setGender($gender)
    {
        ...
        if (!is_null($gender) && (mb_strlen($gender) > 20)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling Patient., must be smaller than or equal to 20.');
        }
    ...
    public function setPersonalIdNumber($personal_id_number)
    {
        ...
        if (!is_null($personal_id_number) && (mb_strlen($personal_id_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $personal_id_number when calling Patient., must be smaller than or equal to 100.');
        }
    ...
    public function setHealthInsurancePolicyNumber($health_insurance_policy_number)
    {
        ...
        if (!is_null($health_insurance_policy_number) && (mb_strlen($health_insurance_policy_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $health_insurance_policy_number when calling Patient., must be smaller than or equal to 50.');
        }
    ...
    public function setHealthInsuranceCompanyNumber($health_insurance_company_number)
    {
        ...
        if (!is_null($health_insurance_company_number) && (mb_strlen($health_insurance_company_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $health_insurance_company_number when calling Patient., must be smaller than or equal to 50.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling Patient., must be smaller than or equal to 100.');
        }
    ...
    public function setAddressZipCode($address_zip_code)
    {
        ...
        if (!is_null($address_zip_code) && (mb_strlen($address_zip_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_zip_code when calling Patient., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressCity($address_city)
    {
        ...
        if (!is_null($address_city) && (mb_strlen($address_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_city when calling Patient., must be smaller than or equal to 100.');
        }
    ...
    public function setAddressCountry($address_country)
    {
        ...
        if (!is_null($address_country) && (mb_strlen($address_country) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_country when calling Patient., must be smaller than or equal to 100.');
        }
