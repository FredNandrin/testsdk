...
/**
 * ProductDtoBookingReadReactGeolocationRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class ProductDtoBookingReadReactGeolocationRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductDto-booking.read_react_geolocation.read';
