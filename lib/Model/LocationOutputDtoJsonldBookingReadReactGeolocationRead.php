<?php
/**
 * LocationOutputDtoJsonldBookingReadReactGeolocationRead
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * LocationOutputDtoJsonldBookingReadReactGeolocationRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class LocationOutputDtoJsonldBookingReadReactGeolocationRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LocationOutputDto.jsonld-booking.read_react_geolocation.read';
